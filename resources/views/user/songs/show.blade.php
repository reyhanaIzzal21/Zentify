...
<div class="container">
    <div class="card">
        <div class="song-card">
            @if($song->image_path)
                <img id="audio-thumbnail" src="{{ asset('storage/' . $song->image_path) }}" alt="{{ $song->title }}" class="img-fluid thumbnail">
            @else
    ...
    <div class="col-md-8">
        ...
        <div class="audio-control">
            <div class="audio-info">
                <img id="audio-thumbnail" src="{{ asset('storage/' . $song->image_path) }}" alt="Song Thumbnail" class="thumbnail">
