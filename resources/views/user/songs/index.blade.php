...
<form action="{{ route('user.songs.index') }}" method="GET" class="search-bar">
    ...
    <input type="text" name="search" placeholder="Cari lagu atau artis..." value="{{ request()->get('search') }}" class="form-search">
</form>
...
<section class="container-ps">
    ...
    <div class="sidebar">
        <div class="item one">
            ...
            <div class="btn-cp-np">
                <a href="{{ route('user.playlists.create') }}" class="btn-cp btn-primary mt-3"><i class="fa-solid fa-plus"></i><p>Buat Playlist</p></a>
