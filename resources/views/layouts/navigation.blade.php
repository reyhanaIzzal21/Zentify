<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-900 dark:border-gray-900">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link href="songs" :active="request()->routeIs('user.songs')">
                        {{ __('Lagu') }}
                    </x-nav-link>
                    <x-nav-link href="playlists" :active="request()->routeIs('user.playlist')">
                        {{ __('Playlist') }}
                    </x-nav-link>
