...
<body>
    <x-guest-layout>
        ...
        <div class="rounded-lg shadow-lg max-w-3xl w-full flex overflow-hidden p-4 container-register">
            <!-- Gambar -->
            <div class="hidden md:block w-1/2 bg-cover bg-center custom-icon " style="background-image: url('{{ asset('item/item-register.png') }}'); background-size: contain; background-repeat: no-repeat; background-position: center;"></div>
            ...
            <div class="w-full md:w-1/2 p-8 space-y-6 flex flex-col justify-center">
                ...
                <form method="POST" action="{{ route('register') }}" autocomplete="off" class="space-y-6">
                    ...
                    <div class="space-y-1">
                        ...
                        <x-text-input id="name" class="block w-full bg-[var(--abu-lebih-muda)] border-none rounded-lg text-[var(--hitam)] placeholder-[var(--abu-muda)] focus:ring-2 focus:ring-[var(--biru)]" 
                    ...
                    <div class="space-y-1">
                        ...
                        <x-text-input id="email" class="block w-full bg-[var(--abu-lebih-muda)] border-none rounded-lg text-[var(--hitam)] placeholder-[var(--abu-muda)] focus:ring-2 focus:ring-[var(--biru)]" 
                    ...
                    <div class="space-y-1">
                        ...
                        <x-text-input id="password" class="block w-full bg-[var(--abu-lebih-muda)] border-none rounded-lg text-[var(--hitam)] placeholder-[var(--abu-muda)] focus:ring-2 focus:ring-[var(--biru)]"
                    ...
                    <!-- Confirm Password -->
                    <div class="space-y-1">
                        <x-input-label for="password_confirmation" :value="__('Konfirmasi Password')" class="text-[var(--putih)] font-medium" />
                        <x-text-input id="password_confirmation" class="block w-full bg-[var(--abu-lebih-muda)] border-none rounded-lg text-[var(--hitam)] placeholder-[var(--abu-muda)] focus:ring-2 focus:ring-[var(--biru)]"
                        ...
                        <div class="flex items-center justify-end mt-4">
                            <a href="{{ route('login') }}" class="underline text-sm text-[var(--biru)] hover:text-[var(--biru-tua)]">
                            {{ __('Log In') }}
                        </a>
                        
                        <x-primary-button class="ms-4 bg-[var(--biru)] hover:bg-[var(--biru-tua)] text-[var(--putih)] py-3 rounded-lg font-semibold shadow-lg transition ease-in-out duration-300">
                            {{ __('Daftar') }}
                        </x-primary-button>
                    </div>
                </form>
